...
export async function GET() {
  const manifest = {
    ...
    frame: {
      version: "1",
      name: "Numberzz",
      iconUrl: "https://numberzz.vercel.app/icon.png",
      homeUrl: "https://numberzz.vercel.app",
      imageUrl: "https://numberzz.vercel.app/hero.png",
      splashImageUrl: "https://numberzz.vercel.app/splash.png",
      splashBackgroundColor: "#000000",
      webhookUrl: "https://numberzz.vercel.app/api/webhook",
